...
- Rawrs: green, plant-like monsters chasing the Bugs. These are the predator of the Bugs. If a Rawr catches a Bug the Bug has a chance of dieing. There is also a chance that the Bug will kill the Rawr if the Bug has a high hunting stat.
